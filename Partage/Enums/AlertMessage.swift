...
enum AlertMessage: String {
  ...
  case locationOff = "L'accès à la localisation n'a pas été autorisé. Vous pouvez changez vos réglages dans les paramètres et accéder à cette fonctionnalité"
  case noPictureloaded = "Partage n'a pas pu télécharger votre image. Merci de vérifier vos paramètres"
  case cameraUse = "L'accès à votre caméra et album n' est pas autorisé. Vous pouvez changez vos réglages dans les paramètres et accéder à cette fonctionnalité"
}
